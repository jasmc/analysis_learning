...
# pip install Bottleneck contourpy debugpy h5py imageio matplotlib numba numpy pandas plotly scikit-image scipy seaborn tifffile xarray

# pip install executing imagecodecs imageio Jinja2 --upgrade
