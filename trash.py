...
#* Initialize fish...
	@classmethod
	def from_raw_data_hdf(cls, fish_name: str, store: 'AllRawData'):
	# , AllMetadata: table
		#TODO know experiment and condition from pandas dataframe with list of all fish from all experiments
...
#!!!!!!!!!!!!!
	...
	def update_from_data_store(self, store: AllRawData):
