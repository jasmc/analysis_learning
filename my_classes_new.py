...
Defines the experiment, fish, and imaging data classes used across the pipeline.
This is a lightly cleaned version of the original module with added structure and
export hints for downstream scripts.
"""
